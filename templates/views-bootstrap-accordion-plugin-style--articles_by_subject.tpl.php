  ...
  <?php foreach ($rows as $key => $row): ?>
   <div class="panel panel-default">
			  ...
			  <div class="row database_title" style="padding:10px 10px 5px 10px; border-bottom:1px solid #cccccc;">
					<div class="col-md-8"><h4><?php print $view->style_plugin->get_field($key, "field_link_2"); ?></h4> <p><?php print $view->style_plugin->get_field($key, "field_coverage"); ?></p></div>
					<div class="col-md-4"><h5><a href="<?php print $view->style_plugin->get_field($key, "field_link_1"); ?>" target="_blank">Access Database <span class="glyphicon glyphicon-new-window"></span></a></h5></div>
			  </div>
