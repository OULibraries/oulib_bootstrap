...
<div class="location_index"> 
	<div class="row">
		...
		<div class="col-md-8 col-md-push-2 col-sm-push-2 col-xs-push-0  col-sm-6 col-xs-12"> 
			...
			<div class="location_index_hours" style="float:left;"><?php print render($content['field_fullhours']); ?></div> <div class="locations_index_site" style="float:left;"><a href="<?php print $node_url; ?>">Website <span class="glyphicon glyphicon-new-window"></span></a></div>
