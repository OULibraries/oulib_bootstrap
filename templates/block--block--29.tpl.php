      ...
      <div id="searchBarTabsContent" class="tab-content hidden-xs">
        ...
        <div aria-labelledby="tab_dlocal" role='tabpanel' class="tab-pane fade" id="dlocal">
          ...
          <div class="search_link_section">
            ...
            <a id="dlocal_browse_link" aria-label="Browse Local Catalog by subject (external link)" target="_blank" href="https://ou-primo.hosted.exlibrisgroup.com/primo-explore/browse?vid=OUNEW">Browse</a>
