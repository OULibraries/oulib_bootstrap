<?php
   ...
   *   they can be found in the html.tpl.php template in this directory.
   *
   * Available variables:
   *
          ...
          <?php else: ?>
            <section id="block-cas-login" class="block block-cas clearfix">
              <form action="/cas?destination=frontpage" method="post" id="cas-login-form" accept-charset="UTF-8">
                <div>
                  <div id="edit-cas-login-redirection-message" class="form-item form-type-item form-group"></div>
                  <input type="hidden" name="form_build_id" value="form-Gm065TacH3qG57x2RRjpW_lCQkVsYpHoDaoA36o-knA">
                  <input type="hidden" name="form_id" value="cas_login_block">
                  <div class="form-actions form-wrapper form-group" id="edit-actions">
                    <button type="submit" id="edit-submit" name="op" value="Login" class="btn btn-default form-submit">Login</button>
                  </div>
                </div>
              </form>
            </section>
      ...
      <div class="row" style="padding-top: 20px;">
        ...
        <div class="col-md-4">
          <span style="width: 50%; float: left;">
            <ul>
              <li><a href="/contact" alt="Contact Us link">Contact Us</a></li>
              <li><a href="/aboutsite" alt="About link">About This Site</a></li>
              <li><a href="http://www.ou.edu/publicaffairs/WebPolicies/accessstatement.html" alt="Accessibility link" target="_blank">Accessibility</a></li>
              <li><a href="https://libraries.ou.edu/jobs" alt="Jobs link" target="_blank">Job Opportunities</a></li>
            </ul>
          </span>
          <div style="width: 50%; float: right;">
            <ul>
              <li><a href="http://www.ou.edu/content/publicaffairs/WebPolicies/copyright.html" alt="Copyright link" target="_blank">Copyright</a></li>
              <li><a href="http://www.ou.edu/content/web/landing/policy.html" alt="Policies link" target="_blank">Policies</a></li>
              <li><a href="http://www.ou.edu/content/web/landing/legalnotices.html" alt="Legal Notice link" target="_blank">Legal Notice</a></li>
            </ul>
          </div>
        ...
        <div class="col-md-3">
          <div class="social">
            <ul>
              <li><a href="https://www.facebook.com/oulibraries" class="facebook" title="facebook" target="_blank"><img src="../../../../../sites/all/themes/oulib_bootstrap/img/facebook.png" alt="Facebook Icon"></a></li>
              <li><a href="https://twitter.com/OU_Libraries" class="twitter" title="twitter" target="_blank"><img src="../../../../../sites/all/themes/oulib_bootstrap/img/twitter.png" alt="Twitter Icon"></a></li>
              <li><a href="https://www.youtube.com/channel/UCvRR9Wy7ECUS0DQbOp2dnbg" class="youtube" title="youtube" target="_blank"><img src="../../../../../sites/all/themes/oulib_bootstrap/img/youtube.png" alt="YouTube Icon"></a></li>
              <li><a href="https://www.instagram.com/oulibraries/" class="instagram" title="instagram" target="_blank"><img src="../../../../../sites/all/themes/oulib_bootstrap/img/instagram.png" alt="Instagram Icon"></a></li>
            </ul>
          </div>
        </div>
      </div>
